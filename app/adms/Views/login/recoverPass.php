 ...
 <div class="container-login">
		 <div class="wrapper-login">
			 ...
			 <div class="title">
				...
				<span class="">Recuperar Senha</span>	 
			 </div>
			 <!-- fim do cabeçalho do formulário -->

			 <span id="msg"></span>
			 <!-- Inicio do Formulário -->
			 <form method="POST" action="" id="form-recover" class="form-recover">
				...
				<div class="row button">
					...
					<button type="submit" name="btnRecoverPass" value="Recuperar">Recuperar</button>
				</div>
